        ...
        <div className="p-5 sm:w-1/2">
          <div>
            ...
            <div className="text-gray-700 dark:text-white">
              ...
              <p>
                DeerForce er et ny opstartet fællesskab for dem som gerne vil
                lave & opleve noget fedt RP - Vi stræber os nemlig efter at det
                skal være sjovt at spille. Ikke for mange regler der sætter et
                loft for jeres scenarier.
              </p>
              <p className="font-bold">
                Hvordan bliver jeg en del af DeerForce's fælleskab?
              </p>
              <p>
                Når du tilslutter dig vores discord, så er du allerede en del af
                vores fællesskab.
              </p>
              <p>
                Før du kan komme ind og lave dejlig RP på vores server skal du
                dog først igennem en whitelist process.
              </p>
              <p className="font-bold">Whitelist jobs</p>
              <p>
                Kunne du godt tænke dig et whitelistede job, så tjek vores{" "}
                <JobsList jobs={JobsListData} filterCategory="All" />, for åbne
                stillinger
              </p>
              <p className="font-bold">
              ...
              <p>
                Husk at gå ind og tjekke vores super dejlige samarbejdspartnere{" "}
                <Link className="underline" href="https://www.dybhosting.com">
                  Dybhosting
                </Link>
              </p>
            </div>
